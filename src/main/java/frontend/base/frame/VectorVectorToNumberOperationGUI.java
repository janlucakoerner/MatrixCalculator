    ...
    public VectorVectorToNumberOperationGUI(ICalculation calculation) {
        ...
        button.addActionListener(e -> {
            if (DataType.current == DataType.BIG_DECIMAL) {
                ...
                var result = (BigDecimal) calculation.numberCalculation(vector1, vector2);
                numberPanelResult.setValue(result);
                ...
                var result = (Fraction) calculation.numberCalculation(vector1, vector2);
                numberPanelResult.setValue(result);
            }
        });
